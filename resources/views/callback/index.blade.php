                        ...
                        <div class="card-body p-0">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 200px;">ФИО</th>
                                    <th class="text-center" style="width: 150px;">Телефон</th>
                                    <th class="text-center" style="width: 250px;">Электронная почта</th>
                                    <th class="text-center" style="width: 150px;">Дата создания</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($callbacks as $callback)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $callback->email }}</td>
                                        <td class="text-center">
